...
- After required checks turn green, run a just-before-merge unresolved-thread sweep, wait a short settle window, then run a second unresolved-thread sweep to catch late AI bot comments.
